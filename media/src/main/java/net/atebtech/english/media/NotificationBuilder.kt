...
import net.atebtech.english.media.extensions.isSkipToNextEnabled
import net.atebtech.english.media.extensions.isSkipToPreviousEnabled

const val NOW_PLAYING_CHANNEL: String = "net.atebtech.english.media.NOW_PLAYING"
