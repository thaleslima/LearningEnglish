...
package net.atebtech.english.media.library

import android.support.v4.media.MediaBrowserCompat.MediaItem
import android.support.v4.media.MediaMetadataCompat
import net.atebtech.english.media.MusicService
import net.atebtech.english.media.extensions.album
import net.atebtech.english.media.extensions.albumArt
import net.atebtech.english.media.extensions.albumArtUri
import net.atebtech.english.media.extensions.artist
import net.atebtech.english.media.extensions.flag
import net.atebtech.english.media.extensions.id
import net.atebtech.english.media.extensions.title
import net.atebtech.english.media.extensions.urlEncoded
